    ...
    protected void showSplashScreen(final int time) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                ...
                root.setOrientation(LinearLayout.VERTICAL);
                root.setBackgroundColor(Color.parseColor("#BAD791"));
                root.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                        ViewGroup.LayoutParams.MATCH_PARENT, 0.0F));

                ImageView splashscreenView = new ImageView(that.getActivity());
                splashscreenView.setImageResource(that.splashscreen);
                splashscreenView.setScaleType(ImageView.ScaleType.CENTER); // similar to the background-size:cover CSS property
                splashscreenView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT,
